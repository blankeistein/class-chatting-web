...
export default function Test() {
    ...
    return (
        <div className="mx-auto max-w-lg w-full bg-[#F0F7FF] min-h-screen">
            <div
                ref={ref}
                className="flex items-start font-bold justify-center gap-y-2 gap-x-5 flex-wrap select-none p-5 px-10"
            >
                {words.map((word) =>
                    Array.isArray(word) ? (
                        <div className="flex gap-1 flex-wrap">
                            {word.map((char, index) => (
                                <>
                                    <span className="words text-4xl pb-10 transition-all p-1">
                                        {char}
                                    </span>
                                    {index !== word.length - 1 && (
                                        <span className="text-4xl pb-10 py-1">
                                            -
                                        </span>
                                    )}
                                </>
